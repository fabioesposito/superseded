...
- [ ] **GitHub review comments can fail silently** if `f.line`/`f.end_line` fall outside the PR diff hunk (`output/github_pr.py:16-23`). Catch `CalledProcessError` and retry out-of-range comments as top-level review body.
